...
type CountryServiceClient interface {
	...
	CreateCountry(ctx context.Context, in *CountryCreateRequest, opts ...grpc.CallOption) (*Country, error)
}
...
func (c *countryServiceClient) CreateCountry(ctx context.Context, in *CountryCreateRequest, opts ...grpc.CallOption) (*Country, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Country)
...
type CountryServiceServer interface {
	...
	CreateCountry(context.Context, *CountryCreateRequest) (*Country, error)
...
func (UnimplementedCountryServiceServer) CreateCountry(context.Context, *CountryCreateRequest) (*Country, error) {
...
func _CountryService_CreateCountry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CountryServiceServer).CreateCountry(ctx, req.(*CountryCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
