...
func (c *keyServiceClient) GetKey(ctx context.Context, in *KeyRequest, opts ...grpc.CallOption) (*Key, error) {
...
var KeyService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/api/v1/key.proto",
}
